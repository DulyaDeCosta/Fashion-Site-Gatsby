    ...
    <footer className="footer bg-dark mt-auto">
      <div className="container py-4">
        ...
        <div className="row text-center my-2">
          ...
          <div className="col-sm-12" style={{ color: 'darkgray' }}>Equipped to serve the most distinctive tastes, we provide bridal dresses for all occasions to make your special moments even more memorable.</div>
        </div>
        <div className="row text-center my-2">
          <div className="col">
            <a href="https://www.facebook.com/maxifashionhouse/" target="_blank" className="no-text-decor" style={{ color: 'darkgray' }}>
        ...
        <div className="row my-2">
          <div className="col-sm-12 text-center" style={{ color: 'darkgray' }}>
            <p style={{ color: 'darkgray' }}>© 2024 Maxi Fashion House. All rights reserved. <br />
